...
Важно: результат должен быть готов к печати и подаче в суд!
  ...
  ### Отправляем запрос
    ...
    # answer = """Уважаемый Иван Иванович, 2 февраля 2024 года Вы взяли у меня, Сергеева Сергея Сергеевича, 
    # в долг 300 000 (триста тысяч) рублей. Согласно нашему соглашению, Вы обязались вернуть указанную сумму 2 февраля 2025 года. 
    # Однако, на сегодняшний день, долг не возвращен. Сначала Вы переносили сроки возврата на неделю или две, но в июне 2025 года 
    # Вы перестали выходить на связь, не отвечаете на звонки и заблокировали меня в мессенджерах.
    #   На основании вышеизложенного, требую от Вас возврата суммы долга в размере 300 000 рублей в течение 10 (десяти)
    #     календарных дней с момента получения данной претензии. В противном случае, я буду вынужден обратиться 
    #     в суд для защиты своих прав и интересов. Прошу Вас связаться со мной для обсуждения условий возврата долга."""
